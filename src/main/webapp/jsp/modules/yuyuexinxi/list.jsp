...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="picihaoSearch" class="form-control form-control-sm" placeholder="请输入批次号" aria-controls="tableId">
									<label>
										接种区域
									</label>
									<input type="text" id="jiezhongquyuSearch" class="form-control form-control-sm" placeholder="请输入接种区域" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			...
			if($('#picihaoSearch').val() != null && $('#picihaoSearch').val() != ''){
				searchForm.picihao ="%" +  $('#picihaoSearch').val() + "%";
			}
			
			if($('#jiezhongquyuSearch').val() != null && $('#jiezhongquyuSearch').val() != ''){
				searchForm.jiezhongquyu ="%" +  $('#jiezhongquyuSearch').val() + "%";
			}
