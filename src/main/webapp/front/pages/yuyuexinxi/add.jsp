	...
	<body>
			...
			<div class="data-add-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px #e6dfd3","margin":"30px auto","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"0","borderStyle":"solid"}'>
				...
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px #558998","borderColor":"#DCDFE6","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-model="detail.jiezhongquyu" type="text" :readonly="ro.jiezhongquyu" name="jiezhongquyu" id="jiezhongquyu" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
		                <label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">疫苗数量</label>
		                <div class="layui-input-block">
		                    <select name="yimiaoshuliang" id="yimiaoshuliang" lay-filter="yimiaoshuliang"  >
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px #558998","borderColor":"#DCDFE6","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text" name="yuyueshijian" id="yuyueshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">备注：</label>
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px #558998","borderColor":"#DCDFE6","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-model="detail.beizhu" type="text" :readonly="ro.beizhu" name="beizhu" id="beizhu" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                form.on('select(yimiaoshuliang)', function (data) {
                    vue.detail.yimiaoshuliang=data.value;
                });
				...
				vue.detail.yimiaoshuliang = 0
				vue.ro.yimiaoshuliang = false;
				...
				form.on('submit(*)', function(data) {
					...
					// 跨表计算判断
                    var obj = JSON.parse(localStorage.getItem('crossObj'));
                    obj.yimiaoshuliang = obj.yimiaoshuliang - data.yimiaoshuliang
                    if(obj.yimiaoshuliang<0){
                        layer.msg(`疫苗数量不足`, {
					 		time: 2000,
					 		icon: 5
					 	});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('yuyuexinxi/list', 'get', {
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            obj.yimiaoshuliang = parseFloat(obj.yimiaoshuliang) - parseFloat(data.yimiaoshuliang)
