			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        if(o=='quyumingcheng'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.quyumingcheng = true;
                                                continue;
                                        }
                                        if(o=='quyudidian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.quyudidian = true;
                                                continue;
                                        }
                                        if(o=='zuoweishu'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.zuoweishu = true;
                                                continue;
                                        }
                                        if(o=='fuzeren'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('quyuxinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('quyuxinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
